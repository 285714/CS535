...
In this subsection, we will provide you the definition of \textit{Natural Reduction} in two versions. The informal version will provide some general intuition of the natural reduction while the formal one will specify more technical properties of the ``mapping'' process.  
